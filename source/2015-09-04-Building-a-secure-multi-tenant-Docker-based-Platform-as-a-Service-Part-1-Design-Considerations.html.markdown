...
In the next post in this series, we'll talk more about how we went about implementing these requirements and the lessons learnt over the course of running this PaaS for over a year with multiple customers. 